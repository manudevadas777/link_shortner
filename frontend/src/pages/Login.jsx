  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4">
      ...
      <div className="fixed inset-0 pointer-events-none overflow-hidden">
        <div className="absolute -top-40 -left-40 w-80 h-80 rounded-full bg-brand-500/10 blur-[100px]" />
        <div className="absolute -bottom-40 -right-40 w-80 h-80 rounded-full bg-accent-500/10 blur-[100px]" />
      </div>
